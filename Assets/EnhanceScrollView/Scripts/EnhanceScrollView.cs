...
public class EnhanceScrollView : MonoBehaviour
{
    ...
    {
        float evaluateValue = positionCurve.Evaluate(sliderValue + added) * totalHorizontalWidth - totalHorizontalWidth / 2f;
    ...
    public void OnDragEnhanceViewEnd()
    {
        ...
        Debug.Log(closestIndex + "_____");

        bgController.SetUIBG(closestIndex);
    }
}