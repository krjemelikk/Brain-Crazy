...
{
    private readonly static string PATH_PLUGIN = "Assets/Plugin/ReadExcel/Terasurware";
    ...
    void ExportImporter()
    {
        ...
        importerTemplate = importerTemplate.Replace("$ExportAssetDirectry$", Path.GetDirectoryName(filePath) + "/" + className);
