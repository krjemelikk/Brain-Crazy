...
public static class Localization
{
        ...
        foreach (var item in mDictionary)
        {
            foreach (var localizeValue in item.Value)
            {
                ...
                if(localizeValue.Contains("color") || localizeValue.Contains("</" ))
                {
                    ...
                    if(Regex.IsMatch(localizeValue, @"<\s*color=[^>]*>(.*?)<\s*/\s*color>") == false && Regex.IsMatch(localizeValue, @"<\s*COLOR=[^>]*>(.*?)<\s*/\s*COLOR>") == false)
                        Debug.LogError("Localize Error " + localizeValue + "    " + item.Key);
	...
	public static string language
	{
		get
		{
			...
			{
                //KEY_lang,English,Vietnamese,Russian,Spanish,French,Japanese,Korean,Thai,Arabic,Chinese,Portuguese,German,Italian,Indonesian,Turkish,
                ...
                {
                    mLanguage = PlayerPrefs.GetString("Language", "Vietnamese");
                }
                else if (Application.systemLanguage == SystemLanguage.Russian)
                {
                    mLanguage = PlayerPrefs.GetString("Language", "Russian");
                }
                else if (Application.systemLanguage == SystemLanguage.Spanish)
                {
                    mLanguage = PlayerPrefs.GetString("Language", "Spanish");
                }
                else if (Application.systemLanguage == SystemLanguage.French)
                {
                    mLanguage = PlayerPrefs.GetString("Language", "French");
                }
                else if (Application.systemLanguage == SystemLanguage.Japanese)
                {
                    mLanguage = PlayerPrefs.GetString("Language", "Japanese");
                }
                ...
                {
                    mLanguage = PlayerPrefs.GetString("Language", "Thai");
                }
                else if (Application.systemLanguage == SystemLanguage.Arabic)
                {
                    mLanguage = PlayerPrefs.GetString("Language", "Arabic");
                }
                else if (Application.systemLanguage == SystemLanguage.Chinese)
                {
                    mLanguage = PlayerPrefs.GetString("Language", "Chinese");
                }
                else if (Application.systemLanguage == SystemLanguage.Portuguese)
                {
                    mLanguage = PlayerPrefs.GetString("Language", "Portuguese");
                }
                else if (Application.systemLanguage == SystemLanguage.German)
                {
                    mLanguage = PlayerPrefs.GetString("Language", "German");
                }
                else if (Application.systemLanguage == SystemLanguage.Italian)
                {
                    mLanguage = PlayerPrefs.GetString("Language", "Italian");
                }
                else if (Application.systemLanguage == SystemLanguage.Indonesian)
                {
                    mLanguage = PlayerPrefs.GetString("Language", "Indonesian");
                }
                else if (Application.systemLanguage == SystemLanguage.Turkish)
                {
                    mLanguage = PlayerPrefs.GetString("Language", "Turkish");
                }
