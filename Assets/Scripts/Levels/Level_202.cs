...
public class Level_202 : BaseLevel
{
    private int id_Current = -1;
    private int index = -1;
    public List<Level_202_Button> lsAva = new List<Level_202_Button>();

    public Text txtTimeReset;
    ...
    protected override void Update()
    {
        ...
        txtTimeReset.text = string.Format("{00:00}", time);
    }
